...
def initialize_upload(
    ...
    body = dict(
        snippet=dict(
            title=title, description=description, tags=tags, categoryId=category
        ),
...
def upload(
    file: str, title: str, description: str, tags: str, category: str, privacy: str
):
    youtube = get_authenticated_service()
    try:
        initialize_upload(youtube, title, description, tags, category, privacy)
    except HttpError as e:
